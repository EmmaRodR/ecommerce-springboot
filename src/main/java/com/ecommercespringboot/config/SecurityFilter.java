...
import com.ecommercespringboot.exceptions.securityExceptions.CustomAccessDeniedHandler;
import com.ecommercespringboot.exceptions.securityExceptions.CustomAuthenticationEntryPoint;
import com.ecommercespringboot.models.enums.Permission;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "api/v1/categories/**").permitAll();
